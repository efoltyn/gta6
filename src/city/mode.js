...
(function () {
  ...
  // The shared rig owns colour, intensity, bounce, aiming and shadow bounds.
  // Keeping a second private set of city keyframes here made the final result
  // depend on whether mode.js or gfx.js happened to write last.
  CBZ.onAlways(94, function () {
    ...
    if (CBZ.lightRig && CBZ.lightRig.cityFrame) CBZ.lightRig.cityFrame(focus);
