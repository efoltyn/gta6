...
(function () {
  ...
  /* ---- THE PIECE THAT CAME OFF -------------------------------------------
     ...
     handed to the water:
       ...
       than seawater — PIECE_SINK), quadratic-ish drag applied as exp(-k dt)
       so a long frame cannot overshoot, and a tumble that spins down with it.
       It SETTLES on the sea floor and stays there — it does not pop. It is a
       piece of an animal lying on the bottom, and it fades out only when the
       budget needs the slot back.
