...
const subjects = [
  ...
  { id: 'face-eye-probe', label: 'Great White — Full Gape, Head-On, Eye Probe', species: HERO, open: 1,
    frame: 2.9, target: [2.45, 0.62, 0], cameraOffset: [8.5, 0.35, 0.05],
    probe: [[0.385, 0.26], [0.395, 0.27], [0.375, 0.27], [0.385, 0.29], [0.615, 0.26], [0.605, 0.27], [0.625, 0.27], [0.615, 0.29], [0.385, 0.24], [0.615, 0.24]],
    focus: 'Rays through where the eyes should be at full gape: eye, rolled-back sclera, or buried under the snout shell?', state: 'FULL GAPE · EYE PROBE', metric: 'probe' },
