...
const subjects = [
  ...
  { id: "exit-walk", label: "The walkway to the exit", hud: false,
    focus: "From the stop line looking south down the fenced walkway at the sally port's entry: glass doors, the plate, the lamp, the building over the wall.",
    cam: { x: 0.6, y: 1.7, z: 110.5, ax: 0, ay: 2.4, az: 121 } },
  { id: "exit-inside", label: "Inside the sally port", hud: false,
    focus: "Just through the entry, looking south at the grille on the wall line: painted block, polished floor, strips, the EXIT sign over the bars, the booth window on the left.",
    cam: { x: 0.4, y: 1.6, z: 122.4, ax: 0, ay: 2.2, az: 128 } },
  { id: "exit-out", label: "The way out, from outside", hud: false,
    focus: "Beyond the wall looking back at the outer door: green steel, wired window, crash bar, the lamp and the plate over it.",
    cam: { x: 1.5, y: 1.7, z: 141, ax: 0, ay: 2.0, az: 134.5 } },
