...
const subjects = [
  ...
  { id: "stack-whole", label: "The whole stack", hud: false,
    ...
    cam: { lat: 3.4, along: 2.0, y: 1.70, aimLat: 0.0, aimY: 1.45, aimAlong: 0.0 } },
  { id: "top-rack", label: "Someone asleep on the upper rack", hud: false,
...
async function stagePerch(input) {
  ...
  if (act.topRack && cell.bedTop && CBZ.propSleep) {
    try { CBZ.propSleep(actor, cell.bedTop, { instant: true }); } catch (_) {}
    step(0.4);
  } else if (actor._propBed || actor._propLie) {
